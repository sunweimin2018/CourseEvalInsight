...
const props = defineProps<{
  modelValue: Module5Data | string | null
  status: string
  loading: boolean
}>()
...
<template>
  <div v-loading="loading" element-loading-text="生成中..." element-loading-fullscreen element-loading-lock>
    ...
    <!-- 4.2 -->
    <h3 style="margin-top: 24px">4.2 本年度课程教学环节发现的问题、相应持续改进的措施以及描述预期将可能达到的效果</h3>
    ...
    <!-- 4.3 -->
    <h3 style="margin-top: 24px">4.3 其他可用的协助持续改进的资源</h3>
    <el-input
